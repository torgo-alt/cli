...
describe('Retrieving sarif result', () => {
  it('should not include locations when target file is not present', () => {
    let result = getResults(getTestResult());
  ...
  it('should include locations when target file is present', () => {
